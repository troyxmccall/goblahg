  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12 lead">
        ...
        <p>- To <strong>add tags</strong> to your post, write their names into the bottom left field. Don't forget to seperate them by commas, e.g. "Tag 1, Tag 2, Tag 3" (without quotation marks). Note that it doesn't matter if you add a space after a comma
          or not.</p>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="help-inner-col">
          ...
          <br>
          <br> Just follow your paragraph with a blank new line.
          <br>
          <hr>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="help-inner-col">
          ...
          <hr> Or use the image upload function by clicking on <span class="glyphicon glyphicon-picture" aria-hidden="true"></span> in the top right corner of your edit area!
        </div>
      </div>
    </div>
    <!-- Blockquotes -->
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="help-inner-col">
          ...
          <hr>
          <blockquote>
            <p>You can quote text like this.</p>
          </blockquote>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="help-inner-col">
          1. Nested lists are done
          <br> &nbsp;&nbsp;1. with two spaces
          <br> &nbsp;&nbsp;2. before the second level
          <br> 2. You can also
          <br> &nbsp;&nbsp;* add levels
          <br> &nbsp;&nbsp;* that are unordered
          <br> 3. And as many items as you like
          <br>
          <hr>
          <ol>
            <li>Nested lists are done
              <ol>
                ...
                <li>before the second level</li>
              </ol>
            </li>
            <li>You can also
              <ul>
                <li>add levels</li>
                <li>that are unordered</li>
              </ul>
            </li>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="help-inner-col">
          ...
          <br>
          <br> Great for talking about `&lt;html&gt;` tags!
          <hr>
