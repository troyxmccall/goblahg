...
import (
  ...
  "github.com/troyxmccall/goblahg/configuration"
  "github.com/troyxmccall/goblahg/database"
  "github.com/troyxmccall/goblahg/filenames"
  "github.com/troyxmccall/goblahg/flags"
  "github.com/troyxmccall/goblahg/plugins"
  "github.com/troyxmccall/goblahg/server"
  "github.com/troyxmccall/goblahg/structure/methods"
  "github.com/troyxmccall/goblahg/templates"
)
...
func checkHttpsCertificates() {
  ...
  err := gogencerts.Check(filenames.HttpsCertFilename, filenames.HttpsKeyFilename)
  if err != nil {
    ...
    err := gogencerts.Generate(filenames.HttpsCertFilename, filenames.HttpsKeyFilename, configuration.Config.HttpsUrl)
    if err != nil {
